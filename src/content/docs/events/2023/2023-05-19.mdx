...
<CardGrid>
  <Card title="20:47" icon="image">
    <Image src={img2047} alt="Herbert Grönemeyer um 20:47" width={300} />
  </Card>
  <Card title="20:51" icon="image">
    <Image src={img2051} alt="Herbert Grönemeyer um 20:51" width={300} />
  </Card>
  <Card title="20:56" icon="image">
    <Image src={img2056} alt="Herbert Grönemeyer um 20:56" width={300} />
  </Card>
</CardGrid>
